...
tester.run("textlint-rule-google-ellipses", rule, {
    ...
    invalid: [
        ...
        {
            text: 'My high school English teacher made me learn that Shakespeare quote about all the world being a stage and " ... all the men and women merely players."',
            errors: [
                {
                    index: 106,
                },
        ...
        // end of text
        {
            text: 'My high school English teacher made me learn that Shakespeare quote: "All the world\'s a stage, And all the men and women merely players ...."',
            errors: [
                {
                    index: 137,
                },
        ...
        // space
        {
            ...
            output: "You don't need to understand all the other Python code in there ... we'll explain it all in class.",
            errors: [
                {
                    index: 58,
                },
